...
import { X, Plane, Home, PartyPopper, Tag, Check, Users } from 'lucide-react';
      ...
      <div className="bg-slate-900 border border-slate-700/80 rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-850">
          <div className="flex items-center space-x-2.5">
            ...
            <h3 className="text-lg font-bold text-white">Crear Nuevo Grupo</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <input
              type="text"
              required
              placeholder="Ej: Viaje a Bariloche 2026, Casa Compartida..."
              value={name}
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                { type: 'TRIP', label: 'Viaje', icon: <Plane className="w-4 h-4" /> },
                { type: 'HOUSE', label: 'Casa', icon: <Home className="w-4 h-4" /> },
                { type: 'EVENT', label: 'Evento', icon: <PartyPopper className="w-4 h-4" /> },
              ].map((item) => (
                <button
                  type="button"
                  key={item.type}
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="col-span-2">
              ...
              <input
                type="text"
                placeholder="Notas o descripción corta"
                value={description}
